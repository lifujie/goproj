...
#endif
    public:
        demuxer(void):hdmv(false),av_only(true),parse_only(false),dump(0),channel(0),base_pts(0),pes_output(0),verb(false),es_parse(false),subs(0),subs_num(0),parse_pat_ft(1),parse_pmt_ft(1) {}
